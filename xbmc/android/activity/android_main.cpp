...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass cMain = env->FindClass("ag/tvaddons/xbmc/Main");
  if(cMain)
  {
  ...
  jclass cBroadcastReceiver = env->FindClass("ag/tvaddons/xbmc/XBMCBroadcastReceiver");
  ...
  jclass cFrameAvailableListener = env->FindClass("ag/tvaddons/xbmc/XBMCOnFrameAvailableListener");
