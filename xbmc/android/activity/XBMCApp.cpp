...
CXBMCApp::CXBMCApp(ANativeActivity* nativeActivity)
  ...
  , CJNIBroadcastReceiver("ag/tvaddons/xbmc/XBMCBroadcastReceiver")
  , m_wakeLock(NULL)
{
...
bool CXBMCApp::getWakeLock()
{
  ...
  m_wakeLock = new CJNIWakeLock(CJNIPowerManager(getSystemService("power")).newWakeLock("ag.tvaddons.xbmc"));
...
void CXBMCApp::SetupEnv()
{
  ...
  if (!androidPath)
    androidPath = getDir("ag.tvaddons.xbmc", 1);
